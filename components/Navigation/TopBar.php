...
class TopBar extends Component
{
    ...
    protected function markup(): Component|array|null
    {
        ...
        [
            ...
            tag('span', children: 
                array_map(
                    fn($lang, $alias) => tag('a', class: 'mr-4 text-white hover:brightness-90 active:brightness-70', href: URLGenerator::generatePageUrl($_GET['page'] ?? '/', [ 'change_lang' => $lang ]), children: text($alias)),
