...
class Paginator extends Component
{
    ...
    protected function markup(): Component|array|null
    {
        if (ceil($this->totalItems / $this->numResultsOnPage) > 0)
            ...
            [
                $this->pageNum > 1 ? tag('li', class: 'prev', children: [ tag('a', href: "?" . self::currQS() . self::addQSpagNum($this->pageNum - 1), children: [ text(I18n::get('forms.prevPage')) ]) ] ) : null,
                $this->pageNum > 3 ?
                [
                ...
                $this->pageNum < (ceil($this->totalItems / $this->numResultsOnPage)) ? tag('li', class: 'next', children: [ tag('a', href: "?" . self::currQS() . self::addQSpagNum($this->pageNum + 1), children: [ text(I18n::get('forms.nextPage')) ]) ] ) : null
            ]);
        else
            return null;
    }
