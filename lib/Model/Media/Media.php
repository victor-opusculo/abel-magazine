...
namespace VictorOpusculo\AbelMagazine\Lib\Model\Media;

use Exception;
use mysqli;
use VictorOpusculo\AbelMagazine\Lib\Helpers\System;
use VictorOpusculo\AbelMagazine\Lib\Model\Media\Upload\MediaUpload;
 ...
 * @property Option file_extension
 */
final class Media extends DataEntity
{
    public function __construct(?array $initialValues = null)
    {
        ...
        [
            ...
            'file_extension' => new DataProperty('file_extension', fn() => '', DataProperty::MYSQL_STRING)
        ];
