 ...
 */
class EditorialTeamPageIdEnglish extends DataEntity
{
    public function __construct($initialValues = null)
    {
        $this->properties = (object)
        [
            'name' => new DataProperty(null, fn() => 'EDITORIAL_TEAM_PAGE_ID_EN', DataProperty::MYSQL_STRING),
            'value' => new DataProperty(null, fn() => null, DataProperty::MYSQL_STRING)
        ];
        parent::__construct($initialValues);

        $this->name = Option::some('EDITORIAL_TEAM_PAGE_ID_EN');
    }

    protected string $databaseTable = 'settings';
    protected string $formFieldPrefixName = 'editorialTeamPageIdEnglish';
