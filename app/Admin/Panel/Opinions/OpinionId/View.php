...
final class View extends Component
{
    ...
    {
        HeadManager::$title = I18n::get('pages.viewOpinion');
        $conn = Connection::get();
        try
        {
    ...
    protected function markup(): Component|array|null
    {
        ...
        [
            tag('h1', children: text(I18n::get('pages.viewOpinion'))),
            ...
            component(Label::class, labelBold: true, label: I18n::get('forms.feedbackMessage'), lineBreak: true, children: 
                tag('div', class: 'whitespace-pre-line', children:
                    text($this->opinion->feedback_message->unwrapOr(''))                
                )
            ),

            component(ConvenienceLinks::class,
                deleteUrl: URLGenerator::generatePageUrl("/admin/panel/opinions/{$this->opinion->id->unwrapOr(0)}/delete")
            )
