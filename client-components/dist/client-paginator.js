 // Lego version 1.0.0
  ...
  const __template = function({ state }) {
    ...
    ((Math.ceil(state.totalitems / state.resultsonpage) > 0) ? h("ul", {"class": `pagination`}, [
      ((state.pagenum > 1) ? h("li", {"class": `prev`},         h("a", {"href": `#`, "onclick": this.changePage.bind(this), "data-topage": `${state.pagenum - 1}`}, `${state.lang.forms.prevPage}`)) : ''),
      ...
      ((state.pagenum < Math.ceil(state.totalitems / state.resultsonpage)) ? h("li", {"class": `next`},         h("a", {"href": `#`, "onclick": this.changePage.bind(this), "data-topage": `${state.pagenum + 1}`}, `${state.lang.forms.nextPage}`)) : '')
    ]) : '')
  ]
  }
